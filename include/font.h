// A simple 8x8 pixel font (1-bit per pixel)
#ifndef FONT_H
#define FONT_H
...
const unsigned char font_data[128][8] = {
    ...
    {0x3C,0x66,0x3C,0x36,0x6E,0x3B,0x6E,0x00}, // 38 &
    {0x30,0x30,0x60,0x00,0x00,0x00,0x00,0x00}, // 39 '
    {0x0C,0x18,0x30,0x30,0x30,0x18,0x0C,0x00}, // 40 (
    {0x30,0x18,0x0C,0x0C,0x0C,0x18,0x30,0x00}, // 41 )
    {0x00,0x18,0x66,0x3C,0x3C,0x66,0x18,0x00}, // 42 *
    ...
    {0x66,0xE6,0xF6,0xDE,0xCE,0x66,0x66,0x00}, // 78 N
    {0x3C,0x66,0x66,0x66,0x66,0x66,0x3C,0x00}, // 79 O
    {0x7C,0x66,0x66,0x7C,0x60,0x60,0x60,0x00}, // 80 P
    {0x3C,0x66,0x66,0x66,0x6E,0x3C,0x06,0x0E}, // 81 Q
    ...
    {0x40,0x60,0x30,0x18,0x0C,0x06,0x03,0x00}, // 92 \\
    ...
    {0x00,0x00,0x3E,0x66,0x66,0x3E,0x06,0xFC}, // 103 g
    ...
    {0x00,0x00,0x3E,0x66,0x66,0x3E,0x06,0x0E}, // 113 q
    {0x00,0x00,0x7C,0x66,0x60,0x60,0x60,0x00}, // 114 r
    {0x00,0x00,0x3E,0x60,0x3C,0x06,0x7C,0x00}, // 115 s
    {0x30,0x30,0x7E,0x30,0x30,0x36,0x1C,0x00}, // 116 t
    {0x00,0x00,0x66,0x66,0x66,0x66,0x3E,0x00}, // 117 u
    {0x00,0x00,0x66,0x66,0x66,0x3C,0x18,0x00}, // 118 v
    {0x00,0x00,0xC6,0xC6,0xD6,0xFE,0x6C,0x00}, // 119 w
    {0x00,0x00,0x66,0x3C,0x18,0x3C,0x66,0x00}, // 120 x
    {0x00,0x00,0x66,0x66,0x66,0x3E,0x06,0xFC}, // 121 y
